...
namespace taf
{
    ...
    public:
        ...
        ServerStateDesc(const std::string &settingStateInReg,const std::string &presentStateInReg,const std::string &presentStateInNode,taf::Int32 processId,const std::string &patchVersion,const std::string &patchTime,const std::string &patchUser)
            :settingStateInReg(settingStateInReg),presentStateInReg(presentStateInReg),presentStateInNode(presentStateInNode),processId(processId),patchVersion(patchVersion),patchTime(patchTime),patchUser(patchUser)
        {
        }
        ServerStateDesc()
    ...
    public:
        ...
        virtual void callback_batchPatch(taf::Int32 ret, const std::string& result)
        { throw std::runtime_error("callback_batchPatch() overloading incorrect."); }
        virtual void callback_batchPatch_exception(taf::Int32 ret)
        { throw std::runtime_error("callback_batchPatch_exception() overloading incorrect."); }
    ...
    public:
        ...
        taf::Int32 batchPatch(const taf::PatchRequest & req,std::string &result,const map<string, string> &context = TAF_CONTEXT());
        void async_batchPatch(AdminRegPrxCallbackPtr callback,const taf::PatchRequest & req,const map<string, string> &context = TAF_CONTEXT());
    ...
    public:
        ...
        virtual taf::Int32 batchPatch(const taf::PatchRequest & req,std::string &result,taf::JceCurrentPtr current) = 0;
        static void async_response_batchPatch(taf::JceCurrentPtr current, taf::Int32 _ret, const std::string &result);
