...
namespace taf
{
    ...
    public:
        ...
        BusCommuKey(const std::string &CommuKey,const std::string &IdName,const std::string &ServantName)
            :CommuKey(CommuKey),IdName(IdName),ServantName(ServantName)
        {
        }
        BusCommuKey()
    ...
    public:
        ...
        BusCommuData(const std::string &CommuKey,const std::string &ErrorInfo,const std::string &c2sMmapName,taf::UInt32 c2sMmapSize,const std::string &c2sFifoName,const std::string &s2cMmapName,taf::UInt32 s2cMmapSize,const std::string &s2cFifoName)
            :CommuKey(CommuKey),ErrorInfo(ErrorInfo),c2sMmapName(c2sMmapName),c2sMmapSize(c2sMmapSize),c2sFifoName(c2sFifoName),s2cMmapName(s2cMmapName),s2cMmapSize(s2cMmapSize),s2cFifoName(s2cFifoName)
        {
        }
        BusCommuData()
