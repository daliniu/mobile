...
namespace taf
{
    ...
    public:
        ...
        taf::Int32 findObjectById4Any(const std::string & id,vector<taf::EndpointF> &activeEp,vector<taf::EndpointF> &inactiveEp,const map<string, string> &context = TAF_CONTEXT());
        ...
        taf::Int32 findObjectByIdInSameSet(const std::string & id,const std::string & setId,vector<taf::EndpointF> &activeEp,vector<taf::EndpointF> &inactiveEp,const map<string, string> &context = TAF_CONTEXT());
