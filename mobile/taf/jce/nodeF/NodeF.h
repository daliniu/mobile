...
namespace taf
{
    ...
    public:
        ...
        ServerInfo(const std::string &application,const std::string &serverName,taf::Int32 pid,const std::string &adapter)
            :application(application),serverName(serverName),pid(pid),adapter(adapter)
        {
        }
        ServerInfo()
