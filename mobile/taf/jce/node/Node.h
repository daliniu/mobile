...
namespace taf
{
    ...
    public:
        ...
        virtual void callback_patchPro(taf::Int32 ret, const std::string& result)
        { throw std::runtime_error("callback_patchPro() overloading incorrect."); }
        virtual void callback_patchPro_exception(taf::Int32 ret)
        { throw std::runtime_error("callback_patchPro_exception() overloading incorrect."); }
        ...
        virtual void callback_delCache(taf::Int32 ret, const std::string& result)
        { throw std::runtime_error("callback_delCache() overloading incorrect."); }
        virtual void callback_delCache_exception(taf::Int32 ret)
        { throw std::runtime_error("callback_delCache_exception() overloading incorrect."); }
    ...
    public:
        ...
        taf::Int32 patchPro(const taf::PatchRequest & req,std::string &result,const map<string, string> &context = TAF_CONTEXT());
        void async_patchPro(NodePrxCallbackPtr callback,const taf::PatchRequest & req,const map<string, string> &context = TAF_CONTEXT());
        ...
        taf::Int32 delCache(const std::string & sFullCacheName,const std::string & sBackupPath,const std::string & sKey,std::string &result,const map<string, string> &context = TAF_CONTEXT());
        void async_delCache(NodePrxCallbackPtr callback,const std::string & sFullCacheName,const std::string & sBackupPath,const std::string & sKey,const map<string, string> &context = TAF_CONTEXT());
    ...
    public:
        ...
        virtual taf::Int32 patchPro(const taf::PatchRequest & req,std::string &result,taf::JceCurrentPtr current) = 0;
        static void async_response_patchPro(taf::JceCurrentPtr current, taf::Int32 _ret, const std::string &result);
        ...
        virtual taf::Int32 delCache(const std::string & sFullCacheName,const std::string & sBackupPath,const std::string & sKey,std::string &result,taf::JceCurrentPtr current) = 0;
        static void async_response_delCache(taf::JceCurrentPtr current, taf::Int32 _ret, const std::string &result);
