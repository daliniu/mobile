...
namespace taf
{
    ...
    public:
        ...
        NotifyKey(const std::string &name,const std::string &ip,taf::Int32 page)
    ...
    public:
        ...
        NotifyItem(const std::string &sTimeStamp,const std::string &sServerId,taf::Int32 iLevel,const std::string &sMessage)
            :sTimeStamp(sTimeStamp),sServerId(sServerId),iLevel(iLevel),sMessage(sMessage)
        {
        }
        NotifyItem()
    ...
    public:
        ...
        NotifyInfo(taf::Int32 nextpage,const vector<taf::NotifyItem> &notifyItems)
            :nextpage(nextpage),notifyItems(notifyItems)
        {
        }
        NotifyInfo()
        :nextpage(0)
