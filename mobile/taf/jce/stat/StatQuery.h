...
namespace taf
{
    ...
    public:
        ...
        StatQueryKey(const std::string &name,const std::string &ip,taf::Int32 page)
            :name(name),ip(ip),page(page)
        {
        }
        StatQueryKey()
        :name(""),ip(""),page(0)
    ...
    public:
        ...
        StatQueryData(taf::Int32 curTime,const taf::StatMicMsgHead &head,const taf::StatMicMsgBody &body)
            :curTime(curTime),head(head),body(body)
        {
        }
        StatQueryData()
        :curTime(0)
    ...
    public:
        ...
        StatQueryValue(taf::Int32 nextpage,const vector<taf::StatQueryData> &dataList)
            :nextpage(nextpage),dataList(dataList)
        {
        }
        StatQueryValue()
        :nextpage(0)
