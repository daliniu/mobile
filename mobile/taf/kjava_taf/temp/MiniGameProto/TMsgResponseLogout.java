...
public final class TMsgResponseLogout extends com.qq.taf.jce.JceStruct
{
    public String className()
    {
        return "MiniGameProto.TMsgResponseLogout";
    }
    ...
    public TMsgResponseLogout()
    {
    }

    public TMsgResponseLogout(short nResultID)
    {
        this.nResultID = nResultID;
    }
    ...
    {
        TMsgResponseLogout t = (TMsgResponseLogout) o;
        return (
