...
public final class TMsgRequestHello extends com.qq.taf.jce.JceStruct
{
    public String className()
    {
        return "MiniGameProto.TMsgRequestHello";
    }
    ...
    public TMsgRequestHello()
    {
    }

    public TMsgRequestHello(int iTime)
    {
        this.iTime = iTime;
    }
    ...
    {
        TMsgRequestHello t = (TMsgRequestHello) o;
        return (
