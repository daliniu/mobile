...
public final class TMsgResponseTalkOnTable extends com.qq.taf.jce.JceStruct
{
    public String className()
    {
        return "MiniGameProto.TMsgResponseTalkOnTable";
    }
    ...
    public TMsgResponseTalkOnTable()
    {
    }

    public TMsgResponseTalkOnTable(short nResultID)
    {
        this.nResultID = nResultID;
    }
    ...
    {
        TMsgResponseTalkOnTable t = (TMsgResponseTalkOnTable) o;
        return (
