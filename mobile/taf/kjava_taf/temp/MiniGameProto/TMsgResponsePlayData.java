...
public final class TMsgResponsePlayData extends com.qq.taf.jce.JceStruct
{
    public String className()
    {
        return "MiniGameProto.TMsgResponsePlayData";
    }
    ...
    public TMsgResponsePlayData()
    {
    }

    public TMsgResponsePlayData(short nResultID)
    {
        this.nResultID = nResultID;
    }
    ...
    {
        TMsgResponsePlayData t = (TMsgResponsePlayData) o;
        return (
