...
public final class TMsgResponseStartGame extends com.qq.taf.jce.JceStruct
{
    public String className()
    {
        return "MiniGameProto.TMsgResponseStartGame";
    }
    ...
    public TMsgResponseStartGame()
    {
    }

    public TMsgResponseStartGame(short nResultID, short nRoomID)
    {
        this.nResultID = nResultID;
        this.nRoomID = nRoomID;
    }
    ...
    {
        TMsgResponseStartGame t = (TMsgResponseStartGame) o;
        return (
