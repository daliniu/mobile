...
import com.qq.taf.server.proxy.ConfigPrx;
import com.qq.taf.server.proxy.ConfigPrxHelper;
...
public class RemoteConfig {
	...
	private String getRemoteFile(String fileName, boolean appConfigOnly) {
		...
		String newFile =basePath + "/" + fileName + "." + Millis100TimeProvider.INSTANCE.currentTimeMillis();
