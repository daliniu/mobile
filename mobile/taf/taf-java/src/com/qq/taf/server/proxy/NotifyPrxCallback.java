...
public abstract class NotifyPrxCallback extends com.qq.taf.proxy.ServantProxyCallback
{
    ...
    public abstract void callback_getNotifyInfo(int _ret, com.qq.taf.server.proxy.NotifyInfo stInfo);
    ...
    final public int _onDispatch(String sFuncName, com.qq.taf.ResponsePacket response)
    {
        ...
        switch(iPos)
        {
            case 0:
            {
                ...
                com.qq.taf.server.proxy.NotifyInfo stInfo = new com.qq.taf.server.proxy.NotifyInfo();
                stInfo = (com.qq.taf.server.proxy.NotifyInfo) _is.read(stInfo, 2, true);
