...
public class ClientConfig extends CommunicatorConfig {
	...
	public ClientConfig(
		...
		super(locator,stat,moduleName,syncInvokeTimeout,asyncInvokeTimeout,refreshEndpointInterval,sendThreadNum,asyncThreadNum, isEnableSet, setName);
	}
	...
	public ClientConfig(
		...
		super(locator,stat,moduleName,syncInvokeTimeout,asyncInvokeTimeout,refreshEndpointInterval,sendThreadNum,asyncThreadNum, false, null);
	}
	...
	public static void init(Config conf) {
		...
		boolean isEnableSet = conf.getBool("/taf/application/client<enableset>", false);
		String setName = conf.get("/taf/application/client<setdivision>", null);
		INSTANCE=new ClientConfig(locator,stat,moduleName,syncInvokeTimeout,asyncInvokeTimeout,refreshEndpointInterval,sendThreadNum,asyncThreadNum,isEnableSet, setName);
