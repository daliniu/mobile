...
public final class ConfigPrxHelper extends com.qq.taf.proxy.ServantProxy implements ConfigPrx
{
    ...
    public void async_ListConfig(com.qq.taf.server.proxy.ConfigPrxCallback callback, String app, String server)
    {
        async_ListConfig(callback, app, server, __defaultContext());
    }

    public void async_ListConfig(com.qq.taf.server.proxy.ConfigPrxCallback callback, String app, String server, java.util.Map __ctx)
    {
        com.qq.taf.jce.JceOutputStream _os = new com.qq.taf.jce.JceOutputStream(0);
        _os.setServerEncoding(sServerEncoding);
        _os.write(app, 1);
    ...
    public void async_checkConfig(com.qq.taf.server.proxy.ConfigPrxCallback callback, String appServerName, String filename, String host)
    {
        async_checkConfig(callback, appServerName, filename, host, __defaultContext());
    }

    public void async_checkConfig(com.qq.taf.server.proxy.ConfigPrxCallback callback, String appServerName, String filename, String host, java.util.Map __ctx)
    {
        com.qq.taf.jce.JceOutputStream _os = new com.qq.taf.jce.JceOutputStream(0);
        _os.setServerEncoding(sServerEncoding);
        _os.write(appServerName, 1);
    ...
    public void async_loadConfig(com.qq.taf.server.proxy.ConfigPrxCallback callback, String app, String server, String filename)
    {
        async_loadConfig(callback, app, server, filename, __defaultContext());
    }

    public void async_loadConfig(com.qq.taf.server.proxy.ConfigPrxCallback callback, String app, String server, String filename, java.util.Map __ctx)
    {
        com.qq.taf.jce.JceOutputStream _os = new com.qq.taf.jce.JceOutputStream(0);
        _os.setServerEncoding(sServerEncoding);
        _os.write(app, 1);
    ...
    public void async_loadConfigByHost(com.qq.taf.server.proxy.ConfigPrxCallback callback, String appServerName, String filename, String host)
    {
        async_loadConfigByHost(callback, appServerName, filename, host, __defaultContext());
    }

    public void async_loadConfigByHost(com.qq.taf.server.proxy.ConfigPrxCallback callback, String appServerName, String filename, String host, java.util.Map __ctx)
    {
        com.qq.taf.jce.JceOutputStream _os = new com.qq.taf.jce.JceOutputStream(0);
        _os.setServerEncoding(sServerEncoding);
        _os.write(appServerName, 1);
