...
public class StatTool {
	...
	public static StatMicMsgHead getHead(String masterName, String slaveName, String interfaceName, String masterIp,
			String slaveIp, int slavePort, int returnValue, String setArea, String setID) {
		return TafUtils.getHead(masterName, slaveName, interfaceName, masterIp, slaveIp, slavePort, returnValue, setArea, setID);
	}
	...
	public StatMicMsgHead addStat(String masterName, String slaveName, String interfaceName, String masterIp,
			String slaveIp, int slavePort, int returnValue, List<Integer> _timeStatInterv, String setArea, String setID) {
		StatMicMsgHead head = TafUtils.getHead(masterName, slaveName, interfaceName, masterIp, slaveIp, slavePort, returnValue, setArea, setID);
	...
	public StatMicMsgHead addStat(String masterName, String slaveName, String interfaceName, String masterIp,
			String slaveIp, int slavePort, int returnValue, String setArea, String setID) {
		return addStat(masterName, slaveName, interfaceName, masterIp, slaveIp, slavePort, returnValue, DefaultTimeStatInterv, setArea, setID);
	}
	...
	public void doReportStat(StatFPrxHelper statPrxPrx) {
		...
		for (Entry<StatMicMsgHead, SendMsgStatBody> sendMsgStatBodyEntry : statInfos.entrySet()) {
			...
			TafLoggerCenter.info(sendMsgStatBodyEntry.getKey().masterName + " " + " report call "
					...
					+ "("+sendMsgStatBodyEntry.getKey().setArea+"."+sendMsgStatBodyEntry.getKey().setID+"):" + mbody.count+"_"+mbody.execCount+"_"+mbody.timeoutCount+"_"+mbody.totalRspTime+"_"+mbody.maxRspTime+"_"+mbody.minRspTime);
			i++;
