...
namespace taf
{
    ...
    taf::Int32 QueryFProxy::findObjectById4Any(const std::string &id, vector<taf::EndpointF> &activeEp, vector<taf::EndpointF> &inactiveEp, const map<string, string> &context)
    {
        taf::JceOutputStream<taf::BufferWriter> _os;
        _os.write(id, 1);
        _os.write(activeEp, 2);
    ...
    void QueryF::async_response_findObjectById4Any(taf::JceCurrentPtr current, taf::Int32 _ret, const vector<taf::EndpointF> &activeEp, const vector<taf::EndpointF> &inactiveEp)
    {
        if (current->getRequestVersion() == WUPVERSION || current->getRequestVersion() == WUPVERSION2)
        {
            UniAttribute<taf::BufferWriter, taf::BufferReader>  tafAttr;
    ...
    void QueryFProxy::async_findObjectById4Any(QueryFPrxCallbackPtr callback,const std::string &id,const map<string, string>& context)
    {
        taf::JceOutputStream<taf::BufferWriter> _os;
        _os.write(id, 1);
        std::map<string, string> _mStatus;
    ...
    taf::Int32 QueryFProxy::findObjectByIdInSameSet(const std::string &id, const std::string &setId, vector<taf::EndpointF> &activeEp, vector<taf::EndpointF> &inactiveEp, const map<string, string> &context)
    {
        taf::JceOutputStream<taf::BufferWriter> _os;
        _os.write(id, 1);
        _os.write(setId, 2);
    ...
    void QueryF::async_response_findObjectByIdInSameSet(taf::JceCurrentPtr current, taf::Int32 _ret, const vector<taf::EndpointF> &activeEp, const vector<taf::EndpointF> &inactiveEp)
    {
        if (current->getRequestVersion() == WUPVERSION || current->getRequestVersion() == WUPVERSION2)
        {
            UniAttribute<taf::BufferWriter, taf::BufferReader>  tafAttr;
    ...
    void QueryFProxy::async_findObjectByIdInSameSet(QueryFPrxCallbackPtr callback,const std::string &id,const std::string &setId,const map<string, string>& context)
    {
        taf::JceOutputStream<taf::BufferWriter> _os;
        _os.write(id, 1);
        _os.write(setId, 2);
    ...
    {
        pair<string*, string*> r = equal_range(__taf__QueryF_all, __taf__QueryF_all+6, msg->request.sFuncName);
