...
string Jce2Hpp::writeToJson(const TypeIdPtr &pPtr) const
{
    ostringstream s;
...
string Jce2Hpp::writeTo(const TypeIdPtr &pPtr) const
{
    ostringstream s;
    if(EnumPtr::dynamicCast(pPtr->getTypePtr()))
    {
...
string Jce2Hpp::readFromJson(const TypeIdPtr &pPtr, bool bIsRequire) const
{
    ostringstream s;
    if(EnumPtr::dynamicCast(pPtr->getTypePtr()))
    {
...
string Jce2Hpp::readFrom(const TypeIdPtr &pPtr, bool bIsRequire) const
{
    ostringstream s;
    if(EnumPtr::dynamicCast(pPtr->getTypePtr()))
    {
...
string Jce2Hpp::readUnknown(const TypeIdPtr &pPtr) const
{
    ostringstream s;
    s << TAB << "_is.readUnknown(sUnknownField, "<<  pPtr->getTag() << ");" <<endl;
    return s.str();
}
string Jce2Hpp::writeUnknown() const
{
    ostringstream s;
...
string Jce2Hpp::display(const TypeIdPtr &pPtr) const
{
    ostringstream s;
    if(EnumPtr::dynamicCast(pPtr->getTypePtr()))
    {
...
string Jce2Hpp::displaySimple(const TypeIdPtr &pPtr, bool bSep) const
{
    ostringstream s;
    if(EnumPtr::dynamicCast(pPtr->getTypePtr()))
    {
...
string Jce2Hpp::generateCollection(const TypeIdPtr &pPtr, bool bSep) const
{
    ostringstream s;
...
/*******************************获取定长数组坐标********************************/
int Jce2Hpp::getSuffix(const TypeIdPtr &pPtr) const
{
    BuiltinPtr bPtr = BuiltinPtr::dynamicCast(pPtr->getTypePtr());
...
string Jce2Hpp::toStrSuffix(const TypeIdPtr &pPtr) const
{
    ostringstream s;
...
string Jce2Hpp::tostr(const TypePtr &pPtr) const
{
...
string Jce2Hpp::tostrBuiltin(const BuiltinPtr &pPtr) const
{
    string s;
...
/*******************************VectorPtr********************************/
string Jce2Hpp::tostrVector(const VectorPtr &pPtr) const
{
    //数组类型
    if(pPtr->isArray())
    {
...
/*******************************MapPtr********************************/
string Jce2Hpp::tostrMap(const MapPtr &pPtr) const
{
...
/*******************************StructPtr********************************/
string Jce2Hpp::tostrStruct(const StructPtr &pPtr) const
{
    return pPtr->getSid();
}

string Jce2Hpp::MD5(const StructPtr &pPtr) const
{
    string s;
...
/////////////////////////////////////////////////////////////////////
string Jce2Hpp::tostrEnum(const EnumPtr &pPtr) const
{
    return pPtr->getSid();
}
///////////////////////////////////////////////////////////////////////
string Jce2Hpp::generateH(const StructPtr &pPtr, const string& namespaceId) const
{
    ostringstream s;
...
string Jce2Hpp::generateCpp(const StructPtr &pPtr, const string& namespaceId) const
{
    ostringstream s;
...
/*******************************ContainerPtr********************************/
string Jce2Hpp::generateH(const ContainerPtr &pPtr) const
{
    ostringstream s;
...
string Jce2Hpp::generateCpp(const ContainerPtr &pPtr) const
{
    ostringstream s;
    for(size_t i = 0; i < pPtr->getAllNamespacePtr().size(); i++)
    {
...
/******************************ParamDeclPtr***************************************/
string Jce2Hpp::generateH(const ParamDeclPtr &pPtr) const
{
    ostringstream s;
...
string Jce2Hpp::generateOutH(const ParamDeclPtr &pPtr) const
{
...
string Jce2Hpp::generateCpp(const ParamDeclPtr &pPtr) const
{
    ostringstream s;
...
/******************************OperationPtr***************************************/
string Jce2Hpp::generateCpp(const OperationPtr &pPtr, const string &cn) const
{
    ostringstream s;

    //生成函数声明
    s << TAB << "inline " << tostr(pPtr->getReturnPtr()->getTypePtr()) << " " << cn << "Proxy::" << pPtr->getId() << "(" ;
...
string Jce2Hpp::generateCppAsync(const OperationPtr &pPtr, const string &cn) const
{
    ostringstream s;
    //生成函数声明
    s << TAB << "inline void "<< cn << "Proxy::async_" << pPtr->getId() << "(" ;
...
///////////////////////////////////////////////////////////////////////////////////////////////
string Jce2Hpp::generateDispatchAsyncCpp(const OperationPtr &pPtr, const string &cn) const
{
    ostringstream s;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
string Jce2Hpp::generateHAsync(const OperationPtr &pPtr, bool bEnableLambda) const
{
    ostringstream s;
    vector<ParamDeclPtr>& vParamDecl = pPtr->getAllParamDeclPtr();
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
string Jce2Hpp::generateHLambdaTypeDef(const OperationPtr &pPtr,const string& sInterfaceId) const
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
string Jce2Hpp::generateDispatchCpp(const OperationPtr &pPtr, const string &cn) const
{
    ostringstream s;
    s << TAB << m_sNamespace + "::JceInputStream<" + m_sNamespace + "::BufferReader> _is;" << endl;
...
/////////////////////////////////////////////////////////////////////////////////////////////////
string Jce2Hpp::generateHAsync(const OperationPtr &pPtr, const string& interfaceId) const
{
    ostringstream s;
    vector<ParamDeclPtr>& vParamDecl = pPtr->getAllParamDeclPtr();
...
/////////////////////////////////////////////////////////////////////////////////////////////////
string Jce2Hpp::generateHLambdaAsync(const OperationPtr &pPtr, const string& interfaceId) const
{
    ostringstream s;
    vector<ParamDeclPtr>& vParamDecl = pPtr->getAllParamDeclPtr();
...
/////////////////////////////////////////////////////////////////////////////////////////////////
string Jce2Hpp::generateH(const OperationPtr &pPtr, bool bVirtual, const string& interfaceId) const
{
    ostringstream s;
    vector<ParamDeclPtr>& vParamDecl = pPtr->getAllParamDeclPtr();
...
/******************************InterfacePtr***************************************/
string Jce2Hpp::generateH(const InterfacePtr &pPtr) const
{
    ostringstream s;
...
string Jce2Hpp::generateAsyncResponseCpp(const OperationPtr &pPtr, const string &cn) const
{
    ostringstream s;
    //异步回调
    s << TAB << "inline void " << cn << "::async_response_" << pPtr->getId() << "(taf::JceCurrentPtr current" ;
...
string Jce2Hpp::generateCpp(const InterfacePtr &pPtr, const NamespacePtr &nPtr) const
{
    ostringstream s;
    vector<OperationPtr>& vOperation = pPtr->getAllOperationPtr();
    ...
    //生成Hash实现
    s << TAB << "inline " << pPtr->getId() << "Proxy* " << pPtr->getId() << "Proxy::taf_hash(int64_t key)" << endl;
    s << TAB << "{" << endl;
    INC_TAB;
    ...
    //生成异步回调接口
    s << TAB << "inline int " << pPtr->getId() << "PrxCallback::onDispatch(taf::ReqMessagePtr msg)" << endl;
    s << TAB << "{" << endl;
    INC_TAB;
    ...
    //生成服务端接口
    s << TAB << "inline int " << pPtr->getId() << "::onDispatch(taf::JceCurrentPtr _current, vector<char> &_sResponseBuffer)" << endl;
    s << TAB << "{" << endl;
    INC_TAB;
...
string Jce2Hpp::generateH(const EnumPtr &pPtr) const
{
    ostringstream s;
...
/******************************ConstPtr***************************************/
string Jce2Hpp::generateH(const ConstPtr &pPtr) const
{
    ostringstream s;
...
string Jce2Hpp::generateH(const NamespacePtr &pPtr) const
{
    ostringstream s;
...
string Jce2Hpp::generateCpp(const NamespacePtr &pPtr) const
{
    ostringstream s;
    vector<InterfacePtr>    &is    = pPtr->getAllInterfacePtr();
...
void Jce2Hpp::generateH(const ContextPtr &pPtr) const
{
...
void Jce2Hpp::generateCpp(const ContextPtr &pPtr) const
{
    string n        = taf::TC_File::excludeFileExt(taf::TC_File::extractFileName(pPtr->getFileName()));
    string fileCpp  = m_sBaseDir + "/" + n + ".hpp";
...
void Jce2Hpp::createFile(const string &file, const vector<string> &vsCoder)
{
...
StructPtr Jce2Hpp::findStruct(const ContextPtr &pPtr,const string &id)
{
    string sid = id;
...
string Jce2Hpp::generateCoder(const NamespacePtr &pPtr,const string & sInterface) const
{
    ostringstream s;
    vector<InterfacePtr>    &is    = pPtr->getAllInterfacePtr();
    vector<StructPtr>       &ss    = pPtr->getAllStructPtr();
...
string Jce2Hpp::generateCoder(const InterfacePtr &pPtr) const
{
    ostringstream s;
...
string Jce2Hpp::generateCoder(const OperationPtr &pPtr) const
{
    ostringstream s;
    vector<ParamDeclPtr>& vParamDecl = pPtr->getAllParamDeclPtr();
...
void Jce2Hpp::generateCoder(const ContextPtr &pPtr,const string &sInterface) const
{
