...
string Jce2Cpp::generateH(const OperationPtr &pPtr, bool bVirtual, const string& interfaceId) const
{
    ...
    //////////////////////////////////////////////////
    //## added by zhengqiao,export typeinfo
    s << TAB << "//" << describeType(pPtr->getReturnPtr()->getTypePtr()) << " " << pPtr->getId() << "(";
    for(size_t i =0; i < vParamDecl.size(); i++)
    {
        s << describeType(vParamDecl[i]->getTypeIdPtr()->getTypePtr());
        s << (i==vParamDecl.size()-1?")":",");
    }
    s << endl;
    /////////////////////////////////////////////////
...
string Jce2Cpp::describeType(TypePtr pPtr) const
{
    {
