...
{
    protected String __server__Notify_all[] = 
    {
        "getNotifyInfo",
        "notifyServer",
        "reportServer"
    ...
    public abstract void callback_getNotifyInfo(int _ret, com.qq.taf.server.jce2java.NotifyInfo stInfo);
    ...
    final public int _onDispatch(String sFuncName, com.qq.taf.ResponsePacket response)
    {
        ...
        int iPos = java.util.Arrays.binarySearch(__server__Notify_all, sFuncName);
        ...
        switch(iPos)
        {
            case 0:
            {
                ...
                com.qq.taf.server.jce2java.NotifyInfo stInfo = new com.qq.taf.server.jce2java.NotifyInfo();
                stInfo = (com.qq.taf.server.jce2java.NotifyInfo) _is.read(stInfo, 2, true);
