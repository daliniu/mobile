...
public abstract class LogPrxCallback extends com.qq.taf.proxy.ServantProxyCallback
{
    protected String __server__Log_all[] = 
    {
        "logger"
    };
    ...
    public abstract void callback_logger_exception(int _iRet);

    final public int _onDispatch(String sFuncName, com.qq.taf.ResponsePacket response)
    {

        int iPos = java.util.Arrays.binarySearch(__server__Log_all, sFuncName);
        ...
        switch(iPos)
        {
            case 0:
            {
                ...
                {
                    callback_logger_exception(response.iRet);
