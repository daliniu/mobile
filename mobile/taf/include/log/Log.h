...
namespace taf
{
    ...
    public:
        ...
        static string MD5()
        {
            return "38b28e84e6feb3c5cd1fdb7b4782ca02";
        }
        LogInfo(const std::string &appname,const std::string &servername,const std::string &sFilename,const std::string &sFormat,const std::string &setdivision,taf::Bool bHasSufix,taf::Bool bHasAppNamePrefix,taf::Bool bHasSquareBracket,const std::string &sConcatStr,const std::string &sSepar)
            :appname(appname),servername(servername),sFilename(sFilename),sFormat(sFormat),setdivision(setdivision),bHasSufix(bHasSufix),bHasAppNamePrefix(bHasAppNamePrefix),bHasSquareBracket(bHasSquareBracket),sConcatStr(sConcatStr),sSepar(sSepar)
        {
        }
        LogInfo()
        :appname(""),servername(""),sFilename(""),sFormat(""),setdivision(""),bHasSufix(true),bHasAppNamePrefix(true),bHasSquareBracket(false),sConcatStr("_"),sSepar("|")
        {
        }
        void resetDefautlt()
        {
        ...
        ostream& displaySimple(ostream& _os, int _level=0) const
        {
            ...
            _ds.displaySimple(sSepar, false);
            return _os;
        }
    public:
        std::string appname;
    ...
    {
        return l.appname == r.appname && l.servername == r.servername && l.sFilename == r.sFilename && l.sFormat == r.sFormat && l.setdivision == r.setdivision && l.bHasSufix == r.bHasSufix && l.bHasAppNamePrefix == r.bHasAppNamePrefix && l.bHasSquareBracket == r.bHasSquareBracket && l.sConcatStr == r.sConcatStr && l.sSepar == r.sSepar;
    }
    inline bool operator!=(const LogInfo&l, const LogInfo&r)
    {
        return !(l == r);
    ...
    public:
        ...
        void loggerbyInfo(const taf::LogInfo & info,const vector<std::string> & buffer,const map<string, string> &context = TAF_CONTEXT());
