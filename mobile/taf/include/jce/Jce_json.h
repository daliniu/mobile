...
public:
    ...
    static void readJson(Char& c, const JsonValuePtr & p, bool isRequire = true)
    {
        ...
        {
            c = TC_Common::strto<char>(JsonValueNumPtr::dynamicCast(p)->value);
        }
        else if (isRequire)
        {
            char s[128];
    ...
    static void readJson(UInt8& n, const JsonValuePtr & p, bool isRequire = true)
    {
        if(p && p->getType() == eJsonTypeNum)
        {
            n = TC_Common::strto<UInt8>(JsonValueNumPtr::dynamicCast(p)->value);
        }
        else if (isRequire)
        {
            char s[128];
    ...
    static void readJson(Short& n, const JsonValuePtr & p, bool isRequire = true)
    {
        if(p && p->getType() == eJsonTypeNum)
        {
            n = TC_Common::strto<Short>(JsonValueNumPtr::dynamicCast(p)->value);
        }
        else if (isRequire)
        {
            char s[128];
    ...
    static void readJson(UInt16& n, const JsonValuePtr & p, bool isRequire = true)
    {
        if(p && p->getType() == eJsonTypeNum)
        {
            n = TC_Common::strto<UInt16>(JsonValueNumPtr::dynamicCast(p)->value);
        }
        else if (isRequire)
        {
            char s[128];
    ...
    static void readJson(Int32& n, const JsonValuePtr & p, bool isRequire = true)
    {
        if(p && p->getType() == eJsonTypeNum)
        {
            n = TC_Common::strto<Int32>(JsonValueNumPtr::dynamicCast(p)->value);
        }
        else if (isRequire)
        {
            char s[128];
    ...
    static void readJson(UInt32& n, const JsonValuePtr & p, bool isRequire = true)
    {
        if(p && p->getType() == eJsonTypeNum)
        {
            n = TC_Common::strto<UInt32>(JsonValueNumPtr::dynamicCast(p)->value);
        }
        else if (isRequire)
        {
            char s[128];
    ...
    static void readJson(Int64& n, const JsonValuePtr & p, bool isRequire = true)
    {
        if(p && p->getType() == eJsonTypeNum)
        {
            n = TC_Common::strto<Int64>(JsonValueNumPtr::dynamicCast(p)->value);
        }
        else if (isRequire)
        {
            char s[128];
    ...
    static void readJson(unsigned long& n, const JsonValuePtr & p, bool isRequire = true)
    {
        if(p && p->getType() == eJsonTypeNum)
        {
            n = TC_Common::strto<Int64>(JsonValueNumPtr::dynamicCast(p)->value);
    ...
    static void readJson(Float& n, const JsonValuePtr & p, bool isRequire = true)
    {
        if(p && p->getType() == eJsonTypeNum)
        {
            n = TC_Common::strto<Float>(JsonValueNumPtr::dynamicCast(p)->value);
        }
        else if (isRequire)
        {
            char s[128];
    ...
    static void readJson(Double& n, const JsonValuePtr & p, bool isRequire = true)
    {
        if(p && p->getType() == eJsonTypeNum)
        {
            n = TC_Common::strto<Double>(JsonValueNumPtr::dynamicCast(p)->value);
        }
        else if (isRequire)
        {
            char s[128];
...
public:
    ...
    static JsonValueNumPtr writeJson(unsigned long n)
    {
        return (new JsonValueNum(n,true));
    }
