...
namespace taf
{
    ...
    public:
        ...
        static string MD5()
        {
            return "cac1ed12a7a9885fa62c16a9ba7f6fff";
        }
        StatMicMsgHead(const std::string &masterName,const std::string &slaveName,const std::string &interfaceName,const std::string &masterIp,const std::string &slaveIp,taf::Int32 slavePort,taf::Int32 returnValue,const std::string &slaveSetName,const std::string &slaveSetArea,const std::string &slaveSetID)
            :masterName(masterName),slaveName(slaveName),interfaceName(interfaceName),masterIp(masterIp),slaveIp(slaveIp),slavePort(slavePort),returnValue(returnValue),slaveSetName(slaveSetName),slaveSetArea(slaveSetArea),slaveSetID(slaveSetID)
        {
        }
        StatMicMsgHead()
        :masterName(""),slaveName(""),interfaceName(""),masterIp(""),slaveIp(""),slavePort(0),returnValue(0),slaveSetName(""),slaveSetArea(""),slaveSetID("")
        {
        }
        void resetDefautlt()
        {
        ...
        ostream& displaySimple(ostream& _os, int _level=0) const
        {
            ...
            _ds.displaySimple(slaveSetID, false);
            return _os;
        }
    public:
    ...
    {
        return l.masterName == r.masterName && l.slaveName == r.slaveName && l.interfaceName == r.interfaceName && l.masterIp == r.masterIp && l.slaveIp == r.slaveIp && l.slavePort == r.slavePort && l.returnValue == r.returnValue && l.slaveSetName == r.slaveSetName && l.slaveSetArea == r.slaveSetArea && l.slaveSetID == r.slaveSetID;
    }
    inline bool operator!=(const StatMicMsgHead&l, const StatMicMsgHead&r)
    {
        return !(l == r);
    ...
    public:
        ...
        StatMicMsgBody(taf::Int32 count,taf::Int32 timeoutCount,taf::Int32 execCount,const map<taf::Int32, taf::Int32> &intervalCount,taf::Int64 totalRspTime,taf::Int32 maxRspTime,taf::Int32 minRspTime)
            :count(count),timeoutCount(timeoutCount),execCount(execCount),intervalCount(intervalCount),totalRspTime(totalRspTime),maxRspTime(maxRspTime),minRspTime(minRspTime)
        {
        }
        StatMicMsgBody()
    ...
    public:
        ...
        StatSampleMsg(const std::string &unid,const std::string &masterName,const std::string &slaveName,const std::string &interfaceName,const std::string &masterIp,const std::string &slaveIp,taf::Int32 depth,taf::Int32 width,taf::Int32 parentWidth)
            :unid(unid),masterName(masterName),slaveName(slaveName),interfaceName(interfaceName),masterIp(masterIp),slaveIp(slaveIp),depth(depth),width(width),parentWidth(parentWidth)
        {
        }
        StatSampleMsg()
