...
namespace taf
{
    ...
    public:
        ...
        StatPropMsgHead(const std::string &moduleName,const std::string &ip,const std::string &propertyName,const std::string &setName,const std::string &setArea,const std::string &setID)
            :moduleName(moduleName),ip(ip),propertyName(propertyName),setName(setName),setArea(setArea),setID(setID)
        {
        }
        StatPropMsgHead()
    ...
    public:
        ...
        StatPropInfo(const std::string &policy,const std::string &value)
    ...
    public:
        ...
        StatPropMsgBody(const vector<taf::StatPropInfo> &vInfo)
            :vInfo(vInfo)
        {
        }
        StatPropMsgBody()
