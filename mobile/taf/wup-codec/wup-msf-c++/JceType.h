...
typedef unsigned int    tafUInt32;
...
//type2name
    template<typename T> struct Class__    { static std::string name() { return T::className(); } };
template<> struct Class__<tafMSF::Bool>   { static std::string name() { return "bool"; } };
template<> struct Class__<tafMSF::Char>   { static std::string name() { return "char"; } };
template<> struct Class__<tafMSF::Short>  { static std::string name() { return "short"; } };
template<> struct Class__<tafMSF::Float>  { static std::string name() { return "float"; } };
template<> struct Class__<tafMSF::Double> { static std::string name() { return "double"; } };
template<> struct Class__<tafMSF::Int32>  { static std::string name() { return "int32"; } };
template<> struct Class__<tafMSF::Int64>  { static std::string name() { return "int64"; } };
template<> struct Class__<tafMSF::UInt8>  { static std::string name() { return "short"; } };
template<> struct Class__<tafMSF::UInt16> { static std::string name() { return "int32"; } };
template<> struct Class__<tafMSF::tafUInt32> { static std::string name() { return "int64"; } };
template<> struct Class__<std::string> { static std::string name() { return "string"; } };
template<typename T> struct Class__<std::vector<T> > { static std::string name() { return std::string("list<") + Class__<T>::name() + ">"; } };
template<typename T, typename U> struct Class__<std::map<T, U> > { static std::string name() { return std::string("map<") + Class__<T>::name() + "," + Class__<U>::name() + ">"; } };
