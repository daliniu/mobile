...
namespace tafMSF
{
    struct RequestPacket : public tafMSF::JceStructBase
    {
    public:
        static string className()
        {
            return "tafMSF.RequestPacket";
        }
        static string MD5()
        {
        ...
        void writeTo(tafMSF::JceOutputStream<WriterT>& _os) const
        {
        ...
        void readFrom(tafMSF::JceInputStream<ReaderT>& _is)
        {
        ...
        {
            tafMSF::JceDisplayer _ds(_os, _level);
    ...
    public:
        tafMSF::Short iVersion;
        tafMSF::Char cPacketType;
        tafMSF::Int32 iMessageType;
        tafMSF::Int32 iRequestId;
        std::string sServantName;
        std::string sFuncName;
        vector<tafMSF::Char> sBuffer;
        tafMSF::Int32 iTimeout;
    ...
    struct ResponsePacket : public tafMSF::JceStructBase
    {
    public:
        static string className()
        {
            return "tafMSF.ResponsePacket";
        }
        static string MD5()
        {
