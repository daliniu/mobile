...
String RequestPacket::className()
{
	return (const signed char *)"taf.RequestPacket";
}

String RequestPacket::structName() const
{
	return (const signed char *)"taf.RequestPacket";
}

RequestPacket::RequestPacket()
: iVersion(0),cPacketType(0),iMessageType(0),iRequestId(0),sServantName(String((const signed char *)"")),sFuncName(String((const signed char *)"")),iTimeout(0)
{
}
...
void RequestPacket::reset()
{
    ...
    iMessageType = 0;
    iRequestId = 0;
    sServantName = String((const signed char *)"");
    sFuncName = String((const signed char *)"");
    sBuffer.clear();
    iTimeout = 0;
    context.clear();
    status.clear();
...
void RequestPacket::writeTo(JceOutputStream& _os) const
{
...
void RequestPacket::readFrom(JceInputStream& _is)
{
