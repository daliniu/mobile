...
namespace TestWup.Test
{
    public class TestOne
    {
        ...
        public void TestMapList()
        {
            ...
            client.Put("emptylistJce", new List<TestFriendlInfo>());
            client.Put("emptyMapintstring", new Dictionary<int,string>());
            client.Put("emptyMapintJce", new Dictionary<int, TestFriendlInfo>());
            ...
            List<TestFriendlInfo> emptylistJce = de.Get<List<TestFriendlInfo>>("emptylistJce");
            QTrace.Trace(emptylistJce);

            Dictionary<int,string> emptyMapintstring = de.Get<Dictionary<int,string>>("emptyMapintstring");
            QTrace.Trace(emptyMapintstring);

            Dictionary<int, TestFriendlInfo> emptyMapintJce = de.Get<Dictionary<int, TestFriendlInfo>>("emptyMapintJce");
            QTrace.Trace(emptyMapintJce);
