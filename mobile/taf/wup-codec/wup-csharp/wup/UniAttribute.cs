...
namespace Wup
{
    public class UniAttribute : JceStruct
    {
        ...
        protected short _iVer = Const.PACKET_TYPE_WUP;
        ...
        //public UniAttribute(Dictionary<string, Dictionary<string, byte[]>> _data)
        //{
        //    this._data = _data;
        //}
        ...
        public bool IsEmpty()
        {
            if (_iVer == Const.PACKET_TYPE_WUP3)
            {
        ...
        public void Put<T>(string name, T t)
        {
            ...
            _out.Write(t, 0);
			byte[] sBuffer = JceUtil.getJceBufArray(_out.getMemoryStream());
        ...
        /**
         * 获取一个元素,只能用于wup版本2，如果待获取的数据为wup3，则抛异常
         * @param <T>
         * @param name
         * @return
         * @throws ObjectCreateException
        ...
        private void CheckObjectType(List<string> listTpye, Object o)
        {
            ...
            else if (o is IList)
            {
                ...
                {
                    listTpye.Add("?");
                    //throw new ArgumentException("list  can not is empty");
                }
            }
